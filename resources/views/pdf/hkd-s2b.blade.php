...
<body>
<h1>SỔ THEO DÕI DOANH THU — PHƯƠNG PHÁP DOANH THU (S2-b HKD)</h1>
...
<table>
    <thead>
        <tr>
            ...
            <th style="width:18%">Người mua</th>
            <th style="width:10%">Loại DT</th>
            <th>Diễn giải</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $e['buyer_name'] ?? '' }}</td>
            <td class="center">{{ $e['revenue_category'] }}</td>
            <td>{{ $e['description'] }}</td>
        ...
        @endforelse
        <tr class="total">
            <td colspan="6" style="text-align:right">Cộng</td>
